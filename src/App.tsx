...
function App() {
  ...
  const [recoveringPassword, setRecoveringPassword] = useState(startedFromPasswordRecovery)
  ...
  return (
    <div className="app-shell">
      <header className="app-header">
        ...
        <span className="foundation-mark" aria-label="Foundation ready">F</span>
      </header>

      <NetworkStatus online={online} syncState={syncState} retry={refreshCloudStatus} />
      ...
      <main>
        <section className="foundation-card" aria-labelledby="foundation-title">
          ...
          <p className="foundation-copy">
            Owner-only access, protected cloud data, and offline shell are connected.
          </p>
        ...
        <p className="account-email">SIGNED IN AS {session.user.email?.toUpperCase()}</p>
        <button className="secondary-action" type="button" onClick={handleSignOut} disabled={!online}>
          SIGN OUT
        </button>
...
function NetworkStatus({
  ...
  if (!online) return <div className="status-strip">OFFLINE · SAVED ON DEVICE</div>
  ...
  const label = syncState === 'syncing' ? 'SYNCING' : syncState === 'synced' ? 'SYNCED' : 'ONLINE'
    ...
    <div className="auth-shell">
      <div className="auth-panel">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <button className="text-action" type="button" onClick={handlePasswordReset} disabled={submitting}>
            FORGOT PASSWORD?
          </button>
        </form>
